...
import no.nav.klage.api.controller.view.DokumentReferanse.AvsenderMottaker
import no.nav.klage.api.controller.view.DokumentReferanse.Journalposttype
import no.nav.klage.api.controller.view.DokumentReferanse.Journalstatus
import no.nav.klage.api.controller.view.DokumentReferanse.LogiskVedlegg
import no.nav.klage.api.controller.view.DokumentReferanse.RelevantDato
import no.nav.klage.api.controller.view.DokumentReferanse.Sak
import no.nav.klage.api.controller.view.DokumentReferanse.Tilleggsopplysning
import no.nav.klage.api.controller.view.DokumentReferanse.Utsendingsinfo
import no.nav.klage.api.controller.view.DokumentReferanse.VedleggReferanseForReceipt
...
data class DokumentReferanse(
    ...
    enum class Journalposttype {
        // Inngående dokument: Dokumentasjon som NAV har mottatt fra en ekstern part. De fleste inngående dokumenter er søknader,
        // ettersendelser av dokumentasjon til sak, eller innsendinger fra arbeidsgivere. Meldinger brukere har sendt til "Skriv til NAV"
        // arkiveres også som inngående dokumenter.
        I,

        // Utgående dokument: Dokumentasjon som NAV har produsert og sendt ut til en ekstern part. De fleste utgående dokumenter er
        // informasjons- eller vedtaksbrev til privatpersoner eller organisasjoner. "Skriv til NAV"-meldinger som saksbehandlere har sendt
        // til brukere arkiveres også som utgående dokumenter.
        U,

        // Notat: Dokumentasjon som NAV har produsert selv, uten at formålet er å distribuere dette ut av NAV. Eksempler på notater er
        // samtalereferater med veileder på kontaktsenter og interne forvaltningsnotater.
        N,
    }
