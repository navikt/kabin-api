...
fun TildeltSaksbehandler.toView(): no.nav.klage.api.controller.view.TildeltSaksbehandler =
    no.nav.klage.api.controller.view.TildeltSaksbehandler(
        navIdent = navIdent,
        navn = navn,
    )
        ...
        receivers =
            receivers.map { receiver ->
                Svarbrev.Receiver(
                    ...
                    handling =
                        no.nav.klage.api.controller.view.SvarbrevWithReceiverInput.Receiver.HandlingEnum.valueOf(
                            receiver.handling.name,
                        ),
                )
            },
    )
...
data class PartViewWithUtsendingskanal(
    ...
    fun partViewWithUtsendingskanal(): no.nav.klage.api.controller.view.PartViewWithUtsendingskanal =
        no.nav.klage.api.controller.view.PartViewWithUtsendingskanal(
            identifikator = identifikator,
            type =
                no.nav.klage.api.controller.view.PartType
                    .valueOf(type.name),
            name = name,
            available = available,
            statusList =
