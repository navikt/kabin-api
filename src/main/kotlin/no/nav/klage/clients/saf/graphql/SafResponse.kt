...
data class DokumentoversiktBrukerResponse(
    val data: DokumentoversiktBrukerDataWrapper?,
...
data class DokumentoversiktBrukerDataWrapper(
...
data class JournalpostResponse(
    val data: JournalpostDataWrapper?,
    val errors: List<Error>?,
)

data class JournalpostDataWrapper(
...
enum class SkjermingType {
    ...
    // Indikerer at det har blitt gjort en feil under mottak, journalføring eller brevproduksjon, slik at journalposten eller dokumentene er
    // markert for sletting.
    FEIL,
}
...
enum class Journalposttype {
    // Inngående dokument: Dokumentasjon som NAV har mottatt fra en ekstern part. De fleste inngående dokumenter er søknader, ettersendelser
    // av dokumentasjon til sak, eller innsendinger fra arbeidsgivere. Meldinger brukere har sendt til "Skriv til NAV" arkiveres også som
    ...
    // informasjons- eller vedtaksbrev til privatpersoner eller organisasjoner. "Skriv til NAV"-meldinger som saksbehandlere har sendt til
    // brukere arkiveres også som utgående dokumenter.
    U,
